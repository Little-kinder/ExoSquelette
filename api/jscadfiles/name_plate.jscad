...
function main (param) {
  ...
  o.push(union(p).scale([1 / 3, 1 / 3, 1 / 3]).center([true, true, false]).translate([0, 0, param.thickness]));
  ...
  if (param.title.length) {
    ...
    o.push(union(p).scale([1 / 8, 1 / 8, 1 / 3]).center([true, true, false]).translate([0, -8, param.thickness]));
  }
